...
namespace Explorer.Data.Migrations
{
    ...
    [Migration("20241015104849_SeededLeagues")]
            ...
            modelBuilder.Entity("Explorer.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 48, 48, 992, DateTimeKind.Local).AddTicks(3643),
                            LeagueId = 0,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "India"
                        },
                        new
                        {
                            Id = 2,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 48, 48, 992, DateTimeKind.Local).AddTicks(3666),
                            LeagueId = 0,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Bangladesh"
                        },
                        new
                        {
                            Id = 3,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 48, 48, 992, DateTimeKind.Local).AddTicks(3667),
                            LeagueId = 0,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Russia"
                        });
