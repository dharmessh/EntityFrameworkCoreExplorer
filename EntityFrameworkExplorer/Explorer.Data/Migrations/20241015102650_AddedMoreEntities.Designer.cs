...
namespace Explorer.Data.Migrations
{
    ...
    [Migration("20241015102650_AddedMoreEntities")]
            ...
            modelBuilder.Entity("Explorer.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 26, 49, 869, DateTimeKind.Local).AddTicks(2220),
                            LeagueId = 0,
                        ...
                        new
                        {
                            Id = 2,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 26, 49, 869, DateTimeKind.Local).AddTicks(2244),
                            LeagueId = 0,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Bangladesh"
                        },
                        new
                        {
                            Id = 3,
                            CoachId = 0,
                            CreationDate = new DateTime(2024, 10, 15, 10, 26, 49, 869, DateTimeKind.Local).AddTicks(2245),
                            LeagueId = 0,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Russia"
                        });
