...
namespace Explorer.Data.Migrations
{
    ...
    [Migration("20241015191853_AddrelationShips")]
            ...
            modelBuilder.Entity("Explorer.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 1,
                            CreationDate = new DateTime(2024, 10, 15, 19, 18, 53, 383, DateTimeKind.Local).AddTicks(3860),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "India"
                        },
                        new
                        {
                            Id = 2,
                            CoachId = 2,
                            CreationDate = new DateTime(2024, 10, 15, 19, 18, 53, 383, DateTimeKind.Local).AddTicks(3927),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Bangladesh"
                        },
                        new
                        {
                            Id = 3,
                            CoachId = 3,
                            CreationDate = new DateTime(2024, 10, 15, 19, 18, 53, 383, DateTimeKind.Local).AddTicks(3930),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Russia"
                        });
