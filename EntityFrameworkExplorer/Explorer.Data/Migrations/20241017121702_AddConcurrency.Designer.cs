...
namespace Explorer.Data.Migrations
{
    ...
    [Migration("20241017121702_AddConcurrency")]
            ...
            modelBuilder.Entity("Explorer.Domain.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CoachId = 1,
                            CreationDate = new DateTime(2024, 10, 17, 12, 17, 1, 538, DateTimeKind.Local).AddTicks(7153),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "India",
                            Version = new Guid("00000000-0000-0000-0000-000000000000")
                        ...
                        new
                        {
                            Id = 2,
                            CoachId = 2,
                            CreationDate = new DateTime(2024, 10, 17, 12, 17, 1, 538, DateTimeKind.Local).AddTicks(7182),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Bangladesh",
                            Version = new Guid("00000000-0000-0000-0000-000000000000")
                        ...
                        new
                        {
                            Id = 3,
                            CoachId = 3,
                            CreationDate = new DateTime(2024, 10, 17, 12, 17, 1, 538, DateTimeKind.Local).AddTicks(7185),
                            LeagueId = 1,
                            ModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Russia",
                            Version = new Guid("00000000-0000-0000-0000-000000000000")
