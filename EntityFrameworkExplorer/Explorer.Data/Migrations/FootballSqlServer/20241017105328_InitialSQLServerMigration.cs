...
namespace Explorer.Data.Migrations.FootballSqlServer
{
    ...
    public partial class InitialSQLServerMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "Id", "CoachId", "CreatedBy", "CreationDate", "LeagueId", "ModificationDate", "ModifiedBy", "Name" },
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(2024, 10, 17, 10, 53, 27, 402, DateTimeKind.Local).AddTicks(346), 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "India" },
                    { 2, 2, null, new DateTime(2024, 10, 17, 10, 53, 27, 402, DateTimeKind.Local).AddTicks(382), 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Bangladesh" },
                    { 3, 3, null, new DateTime(2024, 10, 17, 10, 53, 27, 402, DateTimeKind.Local).AddTicks(385), 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Russia" }
                });
